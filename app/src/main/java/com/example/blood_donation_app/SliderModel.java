...
public class SliderModel {
    public SliderModel(String HospitalName,int APositive, int ANegative, int BPositive, int BNegative, int ABPositive, int ABNegative, int OPositive, int ONegative) {
