...
public class DonorDetailsSignupHelperClass {
    public DonorDetailsSignupHelperClass(String newDonorName, String newDonorID, String newDonorEmail, String newDonorPhone, String newDonorLocation) {
